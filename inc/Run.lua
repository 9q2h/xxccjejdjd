...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="حدث") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 00090 or msg.sender_user_id_ == 1419573259) then
return sendMsg(msg.chat_id_,msg.id_," ابشر ",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1419573259 or msg.sender_user_id_ == 1419573259) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل 🔌") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 00090 or msg.sender_user_id_ == 1419573259) then
